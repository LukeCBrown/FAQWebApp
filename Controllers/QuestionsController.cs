...
namespace FAQWebApp.Controllers
{
    public class QuestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FAQuestion,FAQAnswer")] Question question)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FAQuestion,FAQAnswer")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
